...
type ZoneRequirementType struct {
	IDUpload     string
	GovID        string
	TxnData      string
	DigitalID    string
...
var ZoneRequirements = ZoneRequirementType{
	IDUpload:     "ID_UPLOAD",
	GovID:        "GOV_ID",
	TxnData:      "TXN_DATA",
...
// ToPlain returns a human-readable description for a given requirement code
func ZoneRequirementsPlain(requirement string) string {
	switch requirement {
