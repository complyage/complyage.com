...
var ComplyAge = class {
  ...
  constructor(setup) {
    ...
    this.SETUP.version = setup.version || 1;
  ...
  async call(handler, args) {
    ...
    try {
      response = await fetch(url, {
        ...
        credentials: "include",
        body: args ? JSON.stringify(args) : void 0
      });
    } catch (err) {
    ...
    this.DYNAMIC.sessionId = json.keeperId || null, this.DYNAMIC.ipAddress = json.ipAddress || null, this.DYNAMIC.verified = json.verified || false;
...
//# sourceMappingURL=complyage.js.map
