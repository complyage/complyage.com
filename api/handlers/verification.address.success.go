...
func AddressVerifySuccessHandler(w http.ResponseWriter, r *http.Request) {
	...
	var updateRequest interfaces.VerificationAddressUpdateRequest
	...
	updErr := verification.UpdateStatusADDRPendingVerification(updateRequest.UUID, updateRequest.TransactionID, cardType, lastFour, updateRequest.BillingZip, updateRequest.Address)
	if updErr != nil {
