                        ...
                        <div className="relative z-10 flex items-center justify-center min-h-screen px-4 pt-24 pb-12">
                              <div className="bg-base-100 bg-opacity-90 rounded-lg shadow-lg w-full max-w-3xl p-8 text-center mx-auto">
                                    ...
                                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
                                          ...
                                          {/* Centered Advanced Toggle */}
                                          <div className="flex items-center mt-4">
                                                <input
                                                      type="checkbox"
                                                      className="checkbox checkbox-sm mr-2 align-middle"
                                                      checked={isAdvanced}
                                                      onChange={() => setAdvanced(!isAdvanced)}
                                                      style={{ verticalAlign: "middle", height: "1.25rem", width: "1.25rem" }}
                                                />
                                                <span className="text-sm text-gray-300 align-middle" style={{ verticalAlign: "middle" }}>
                                                      ...
                                                      <div className="flex flex-col gap-6">
                                                            ...
                                                            {encryptionLevel === 2 && (
                                                                  <BIP39
                                                                        ...
                                                                        setValue={(words) => setWordList(words)}
                                                                  />
                                                            )}
