...
//||------------------------------------------------------------------------------------------------||
      ...
      import AdvancedChoose                                      from "../../components/dynamic/AdvancedChoose";
                                          ...
                                          <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
                                                ...
                                                <label className="flex items-center gap-2">
                                                      <input
                                                            type="radio"
                                                            value="secure"
                                                            checked={encryptionLevel === "secure"}
                                                            onChange={() => setEncryptionLevel("secure")}
                                                ...
                                                <label className="flex items-center gap-2">
                                                      <input
                                                            type="radio"
                                                            value="advanced"
                                                            checked={encryptionLevel === "advanced"}
                                                            onChange={() => setEncryptionLevel("advanced")}
                                                            className="radio radio-secondary"
                                                      />
                                                      Advanced (you keep your private key)
                                                </label>
