...
export default function IDVStep1({ onNext, onUpload }: IDVStep1Props) {
      //||------------------------------------------------------------------------------------------------||
      //|| Const
      //||------------------------------------------------------------------------------------------------||
      ...
      //|| Upload
      //||------------------------------------------------------------------------------------------------||
      if (captureMode === "upload") return ( <Upload onUpload={ handleUpload } onClose={ () => setCaptureMode(null) } /> );
      //||------------------------------------------------------------------------------------------------||
      //|| Capture
      //||------------------------------------------------------------------------------------------------||
